...
var helmappsResource = schema.GroupVersionResource{Group: "operator.pluma.io", Version: "v1alpha1", Resource: "helmapps"}

var helmappsKind = schema.GroupVersionKind{Group: "operator.pluma.io", Version: "v1alpha1", Kind: "HelmApp"}
